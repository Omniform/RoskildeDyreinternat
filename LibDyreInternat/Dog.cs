...
namespace LibDyreInternat
{
    public class Dog : Animal
    {
        ...
        public Dog(string race, bool isChildFriendly, string foodPrefrences, int chipNumber, string name, int birthYear, int weight, Sex sex) : base(name, birthYear, weight, sex)
        {
            Race = race;
